...
interface DeletePopViewProps {
  onRquestClose: () => void;
  onRequestConfirm: () => void;
}

interface DeletePopViewAllProps extends DeletePopViewProps {
  t: any;
}

function DeletePopView(props: DeletePopViewAllProps):JSX.Element {
  ...
  return (
    <div className="delete-pop-view">
      <div className="delete-content">
        ...
        <div className="delete-desc">{t('delete_selected_videos')}?</div>
...
)(DeletePopView) as React.ComponentType<DeletePopViewProps>;
